                ...
                <div id="property-location">
                    ...
                    <table class="location-table">
                        ...
                        <tr>
                            <td>Street Name:</td>
                            <td>
                                <input type="text" size="30" id="road" name="properties_street_holding"
                                       value="<?= $holding_no ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="village" size="30" name="properties_thana_upozilla"
                                       value="<?= $thana_upozilla ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>District:</td>
                            <td>
                                <input type="text" id="city" size="30" name="properties_district"
                                       value="<?= $district ?>">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>Country:</td>
                            <td>
                                <input type="text" id="country" size="30" name="properties_country"
                                       value="<?= $country ?>">
                            </td>
                        </tr>
                        <tr>
                            <td>Post Code:</td>
                            <td>
                                <input type="text" id="post-code" size="30" name="properties_post_code"
                                       value="<?= $post_code ?>">
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>Latitude:</td>
                            <td>
                                <input type="text" id="latitude" size="30" name="properties_latitude"
                        ...
                        <tr>
                            ...
                            <td>Longitude:</td>
                            <td>
                                <input type="text" id="longitude" size="30" name="properties_longitude"
                        ...
                        <tr>
                            <td>
                                <p id="submit"
                                   style="border:1px solid darkslategrey; background-color: oldlace; width:7em; text-align:center;cursor:pointer">
                                    Show Location</p>
                            </td>
                        </tr>
                    </table>
